...
const NarrativeBlock = () => {
  return (
    <div className="w-full lg:w-[90%] px-4 lg:px-12 h-screen flex gap-2 lg:gap-12 flex-col items-center xl:justify-between xl:flex-row overflow-hidden">
      <div className="w-full xl:w-[50%] flex items-center justify-center ">
        <div className="relative w-[50rem] h-[15rem] lg:h-[25rem] xl:h-[45rem]">
          <Image
            src={TrainLine}
      ...
      <div className="w-full xl:w-[50%] flex flex-col gap-4 items-center">
