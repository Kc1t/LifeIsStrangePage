...
const Comparação = () => {
  return (
    <div className="w-full lg:flex flex-col items-center lg:h-[125vh] gap-6 px-4 py-8 overflow-hidden" id="Comparação">
      ...
      <div className="w-full lg:w-[90%] h-[30vh] lg:h-[90%] relative">
        <video
          src="https://ik.imagekit.io/z3fr9lhps/Life%20is%20Strange%20Page/ComparisonVideo.mp4?updatedAt=1718635555289"
